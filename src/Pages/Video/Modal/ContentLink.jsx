     ...
     <Modal {...props}>
         <div className="">
            ...
            <div className="form--group">
                ...
                <input className="border-bottom form--control" type="text" ref={inputRef} value={url ? url : "" } placeholder="http://demos.rea/app/xaa" style={{paddingBottom:"10px"}}/>
            </div>
