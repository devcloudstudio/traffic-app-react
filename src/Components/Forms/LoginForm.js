	  ...
	  <div className="auth--container d-flex">
	    <div className="modal-wrapper d-flex">
	      <div className="heading text--center mx-4">
	        ...
	        <span className="text--secondary">Please Login To Your Account</span>
	      </div>
	      <form onSubmit={handleSubmit} id="login-form">
	        <div className="form--group">
	          <label className="text--secondary">Email</label>
	          <input value={email} onChange={handleChange} name="email" className="border-bottom form--control" type="text" id="email"/>
	        </div>
	        <div className="form--group">
	          <label className="text--secondary">Password</label>
	          <input value={password} onChange={handleChange} name="password" className="border-bottom form--control" type="password"  id="password"/>
	        </div>
	        ...
	        <div className="btn--group my-2">
	          <button className="btn btn-primary btn--round text--secondary" id="login-button" type="submit">Login</button>
