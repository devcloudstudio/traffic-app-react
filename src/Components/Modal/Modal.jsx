...
const ModalOverlay = ({children,onCancel,leftBtnContent,rightBtnContent,isStyle})=>{
   let style = {
    width: "80%",
    height: "inherit",
    maxWidth:"1000px",
      ...
      <div className="modal" style={isStyle && style}>
         ...
         {leftBtnContent || rightBtnContent ? (
          <div className="btn--group mx-3" >
               ...
               {rightBtnContent &&  <button className="btn btn-outline-primary btn-primary btn--round text--primary" onClick={onCancel}>{rightBtnContent}</button>}
           </div>
           ):""}
      </div>
   )
